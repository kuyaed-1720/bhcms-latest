...
<template>
	<div>
		...
		<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
			<nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
					...
					<div class="flex justify-between h-16">
						<div class="flex">
							...
							<div class="shrink-0 flex items-center">
								...
								<Link :href="route('dashboard')" class="w-6/12 lg:w-auto text-md lg:text-xl ml-4 dark:text-white">Barangay Health Center Monitoring System</Link>
							</div>

							<!-- Navigation Links -->
							<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
								<NavLink :href="route('dashboard')" :active="route().current('dashboard')">Dashboard</NavLink>
								<NavLink :href="route('appointments')" :active="route().current('appointments')">Appointments</NavLink>
							</div>
						</div>
				...
				>
					<div class="pt-2 pb-3 space-y-1">
						...
						<ResponsiveNavLink :href="route('appointments')" :active="route().current('appointments')">Appointments</ResponsiveNavLink>
					</div>
			...
			<!-- Page Heading -->
			<header v-if="$slots.header" class="h-8 lg:h-12 bg-white dark:bg-gray-800 shadow">
				<div class="w-screen h-8 lg:h-12 mx-auto py-2 px-8">
					<slot name="header" />
				</div>
			</header>
